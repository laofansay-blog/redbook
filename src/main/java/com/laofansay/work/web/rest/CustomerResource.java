...
import com.laofansay.work.service.CustomerService;
...
/**
 * REST controller for managing {@link com.laofansay.work.domain.Customer}.
 */
@RestController
...
public class CustomerResource {
    ...
    public ResponseEntity<Customer> createCustomer(@Valid @RequestBody Customer customer) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/customers/" + customer.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, customer.getId()))
            .body(customer);
    }
