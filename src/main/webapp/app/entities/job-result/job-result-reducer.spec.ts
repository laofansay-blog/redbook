...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBRESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JOBRESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JOBRESULT actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_JOBRESULT actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_JOBRESULT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_JOBRESULT actions', async () => {
      const arg = 42666;
