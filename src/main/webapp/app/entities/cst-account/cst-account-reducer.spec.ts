...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CSTACCOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CSTACCOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CSTACCOUNT actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CSTACCOUNT actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CSTACCOUNT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CSTACCOUNT actions', async () => {
      const arg = 42666;
