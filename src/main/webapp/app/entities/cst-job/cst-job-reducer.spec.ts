...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cst-job.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CSTJOB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CSTJOB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CSTJOB actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CSTJOB actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CSTJOB actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CSTJOB actions', async () => {
      const arg = 42666;
