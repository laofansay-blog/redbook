...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './job-order.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JOBORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JOBORDER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_JOBORDER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_JOBORDER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_JOBORDER actions', async () => {
      const arg = 42666;
