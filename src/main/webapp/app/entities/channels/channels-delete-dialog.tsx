...
export const ChannelsDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/channels' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="redBookApp.channels.delete.question">
        <Translate contentKey="redBookApp.channels.delete.question" interpolate={{ id: channelsEntity.id }}>
