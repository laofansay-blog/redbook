...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './channels.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHANNELS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHANNELS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHANNELS actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CHANNELS actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CHANNELS actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CHANNELS actions', async () => {
      const arg = 42666;
