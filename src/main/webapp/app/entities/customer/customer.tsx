  ...
  return (
    <div>
      <h2 id="customer-heading" data-cy="CustomerHeading">
        <Translate contentKey="redBookApp.customer.home.title">Customers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="redBookApp.customer.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/customer/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="redBookApp.customer.home.createLabel">Create new Customer</Translate>
          </Link>
        </div>
      </h2>
        ...
        {customerList && customerList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="redBookApp.customer.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('times')}>
                  <Translate contentKey="redBookApp.customer.times">Times</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('times')} />
                </th>
                ...
                <th>
                  <Translate contentKey="redBookApp.customer.channels">Channels</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {customerList.map((customer, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`redBookApp.CstStatus.${customer.status}`} />
                  </td>
                  <td>{customer.createdDate ? <TextFormat type="date" value={customer.createdDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{customer.channels ? <Link to={`/channels/${customer.channels.id}`}>{customer.channels.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="redBookApp.customer.home.notFound">No Customers found</Translate>
            </div>
          )
        )}
      </div>
